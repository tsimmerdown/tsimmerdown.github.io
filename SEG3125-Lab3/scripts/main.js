...
function populateListProductChoices(slct1) {
	var tempS1 = document.getElementsByName(slct1);
	var s1;
	...
	var tempArray = restrictListProducts(products, s1);
	var optionArray = tempArray[0];
	var priceArray = tempArray[1];
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		categoryName = findCategory(productName);

		s2 = document.getElementById(categoryName);
